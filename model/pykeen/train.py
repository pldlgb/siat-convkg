...
result = pipeline(
    ...
    training_kwargs={'num_epochs': num_epochs},  # 30
    model_kwargs={'embedding_dim': 300},
    stopper='early',
    stopper_kwargs={'frequency': 300, 'stopped': True, 'patience': 1},
...
# =============================================================================
print(result)
result.save_to_directory(f'{save_path}/{dataset}_{model}_{num_epochs}')
